CreditBuyingWindow = function(_navGroup, _userId) {
	...
	//****************** Subscription section come first ***
...
*/
	...
	subscriptionSectionView.add(horizontalSeparator1);	
	...
	var creditPackLabel = Ti.UI.createLabel({
		text: L('Candy Package'),    //Credit Package
		center: {x: '50%', y:27}, 
		color: '#919191',
		font:{fontWeight:'bold',fontSize:16},
		shadowColor: '#ffffff', 
